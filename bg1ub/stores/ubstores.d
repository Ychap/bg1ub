REPLACE_ACTION_TEXT ubba0133
  ~StartStore("\([Tt][Aa][Vv]0154\)",LastTalkedToBy(\(Myself\)?))~
  ~StartStore("tav0133",LastTalkedToBy())~

REPLACE_ACTION_TEXT ubme0706
  ~StartStore("\([Ss][Tt][Oo]4906\)",LastTalkedToBy(\(Myself\)?))~
  ~StartStore("ubst0706",LastTalkedToBy())~

REPLACE_ACTION_TEXT ubmerch
  ~StartStore("\([Ss][Tt][Oo]4901\)",LastTalkedToBy(\(Myself\)?))~
  ~StartStore("sto4907",LastTalkedToBy())~


REPLACE_ACTION_TEXT ALVAHE
  ~StartStore("\([Tt][Ee][Mm]4802\)",LastTalkedToBy(\(Myself\)?))~
  ~StartStore("TEM4003",LastTalkedToBy(Myself))~
  
REPLACE_ACTION_TEXT shop06
  ~StartStore("\([Ss][Tt][Oo]1115\)",LastTalkedToBy(\(Myself\)?))~
...
REPLACE_ACTION_TEXT maltz
  ~StartStore("\([Ss][Tt][Oo]1112\)",LastTalkedToBy(\(Myself\)?))~
...
REPLACE_ACTION_TEXT alyth
  ~StartStore("\([Tt][Aa][Vv]0721\)",LastTalkedToBy(\(Myself\)?))~
